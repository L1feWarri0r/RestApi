 ...
 //heatindex
  ...
  return (
    <div className="absolute top-5 left-0 right-0 mx-10 ">
      <div className="bg-green-600  p-4 rounded-md shadow-md mb-4 flex flex-col md:flex-row items-center justify-between">
      <img
        src={image}
        alt="Sample"
        height={50}
      ...
      />
        <h2 className="text-yellow-400 align-left text-4xl font-bold mb-4 md:mb-0">
        ...
        {selectedDate ? (
          <div className="bg-green-200 top-0 items-center flex flex-col md:flex-row ">
      ...
      {selectedYear && (
        <div className="bg-green-600 w-full flex space-x-4 p-4 rounded-md shadow-md">
          <div className=" bg-green-200 w-1/3 h-auto p-4 rounded-md shadow-md">
      ...
      {selectedYear && (
        <div className=" bg-green-600 my-4 w-full flex space-x-4 p-4 rounded-md shadow-md">
          <div className="bg-green-200 w-1/3 h-auto p-4 rounded-md shadow-md">
            <h2 className="text-xl font-semibold mb-4">
